...
user_pref("browser.urlbar.suggest.searches", false); // domfuzz
...
user_pref("media.peerconnection.use_document_iceservers", true); // domfuzzuser_pref("media.raw.enabled", true);
...
user_pref("media.wave.decoder.enabled", true);
...
user_pref("privacy.trackingprotection.enabled", false); // domfuzz
...
user_pref("webgl.angle.force-warp", true);  // force mesa
